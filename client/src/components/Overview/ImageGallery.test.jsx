...
describe('ImageGallery', () => {
  describe('Default View', () => {
    it.todo('should show the first image in the set by default');
    it.todo('should display up to 7 images');
    ...
    it.todo('should scroll the thumbnail list if navigating the main image carousel yields a thumbnail that is nto visible');
  });
