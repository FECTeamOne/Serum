...
function StarIcon({value, ...props}) {
  ...
  // been eyeballed
  const fillOffsets = [0, .46, .5, .565, 1];
  const valueRoundedToFourth = Math.round(value * 4);
  return (
    <Icon viewBox="0 0 20 19" {...props}>
        <defs>
          <linearGradient id="grad">
            <stop offset={fillOffsets[valueRoundedToFourth]} stopColor="black" />
            <stop offset={fillOffsets[valueRoundedToFourth]} stopColor="white" />
          </linearGradient>
        </defs>
        <path fill="url(#grad)" d="m10,0l-2.582,6.953l-7.418,0.304l5.822,4.602l-2.002,7.141l6.18,-4.11l6.18,4.11l-2.002,-7.14l5.822,-4.604l-7.418,-0.305l-2.582,-6.951z" />
